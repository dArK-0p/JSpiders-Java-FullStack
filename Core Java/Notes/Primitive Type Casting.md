...
- This is specifically referred to as *Primitive Type Casting*.
...
- Conversion of a *lower* datatype value into a *higher* datatype value.
...
- Conversion of a *higher* datatype value into a *lower* datatype value.
